...
const UserSwiper = ({ userSwiperSlides, modalEditState, setModalEditState }: Props) => {
    ...
    return (
        <>
        {showBtn ?
        <button type="button" className="btnEditGradient textShadowSm btnTransition btnShadow w-72
       md:w-80 py-[0.4rem] shadow-md font-bold tracking-wider text-[#FFEAEA] rounded-full fixed top-24 md:top-8"
        ...
        : <UserEditModal modalState={modalEditState} setModalState={setModalEditState} setBtnState={setShowBtn} />}
        </>
    )
}
